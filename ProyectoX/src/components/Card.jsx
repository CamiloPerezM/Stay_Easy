        ...
        <div className={Styles.container}>
            <div className={Styles.card}>
                ...
                <div className={Styles.cardContainer}>
                    ...
                    <span className={Styles.cardLocation}><FontAwesomeIcon icon={faLocationDot} size="1x" className={Styles.iconLocation}/>{`${datos.ciudad.nombre},${datos.ciudad.pais}`} <span > <a className={Styles.cardMostrarMapa} href={datos.ubicacionMaps} target="_blank" rel="noopener noreferrer"> - MOSTRAR EN EL MAPA </a></span></span>
